  ...
  "3102686482824408656": `
{
  ...
  "projects": [
    {
      "description": "A third-party Discord app designed for a smooth experience on desktops, having 1.2k stars on GitHub.",
      "keywords": ["Go", "C", "GTK4"],
      "name": "Dissent",
    ...
    },
    {
      ...
      "description": "Infrastructure-as-code for ACM at CSUF with automatic deployment that vastly improved development speed.",
    ...
    },
    {
      ...
      "description": "Full-stack web/mobile application to match people with long layover flights, won LAHacks 2023."
    }
  ],
  "leadership": [
    {
  ...
  "awards": [
    {
      "summary": "Won the Travel category with Layover Party: a mobile app to match people with long layover flights for partying and cheaper flights.",
